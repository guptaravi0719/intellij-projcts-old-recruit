...
public class player {
    ...
    ImageIcon playerFacingLeft = new     ImageIcon("EvilMario/image/left.png");  //Image for player while he is     turning left
    ImageIcon playerFacingRight = new     ImageIcon("EvilMario/image/right.png");//Image for player while he is turning right
